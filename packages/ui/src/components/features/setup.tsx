...
export const WelcomeDisplay: React.FunctionComponent<{ teamId: string | undefined, account: Account | undefined }> = ({ teamId, account: _account }) => {
    ...
    return (<SetupLayout>
        <WelcomeSetup key={0} data={account || { id: '', firstName: '', lastName: '', role: '', teamId: '', contact: 'example@gmail.com', seenWelcomeScreen: false }} onContinue={onWelcomeContinue} />
    </SetupLayout>)
}
                    ...
                    <g mask="url(#mask0_368_506)">
                        ...
                        <g mask="url(#mask5_368_506)">
                            ...
                            <g mask="url(#mask6_368_506)">
                                <path d="M-33.201 174.52L-14.3184 174.52L-14.3184 164.236L-33.201 164.236L-33.201 174.52ZM-39.538 151.232L21.9545 151.232L21.9545 140.947L-39.538 140.947L-39.538 151.232ZM-123.365 127.945L-93.7059 127.945L-93.7059 117.655L-123.365 117.655L-123.365 127.945ZM-17.3751 104.652L21.9545 104.652L21.9545 94.3682L-17.3751 94.3682L-17.3751 104.652ZM-63.3181 81.3625L21.9545 81.3625L21.9545 71.0852L-63.3181 71.0852L-63.3181 81.3625ZM-118.297 71.0852L-203.565 71.0852L-203.565 81.3625L-118.297 81.3625L-118.297 71.0852ZM-181.158 11.501L-181.158 1.21716L-237.012 1.21716L-237.012 11.501L-181.158 11.501ZM-41.3192 1.21717L-173.736 1.21716L-173.736 11.501L-41.3192 11.501L-41.3192 1.21717ZM21.9545 -22.0724L-32.6894 -22.0724L-32.6894 -11.7885L21.9545 -11.7885L21.9545 -22.0724Z" fill="#AFE1E3" fillOpacity="0.5" />
                            </g>
                            ...
                            <g mask="url(#mask7_368_506)">
                                <path d="M-149.162 151.233L-87.6716 151.233L-87.6716 140.948L-149.162 140.948L-149.162 151.233ZM-86.2838 127.946L21.9545 127.946L21.9545 117.656L-86.2838 117.656L-86.2838 127.946ZM-69.5277 47.7949L-143.917 47.7949L-143.917 58.0764L-69.5277 58.0765L-69.5277 47.7949ZM-33.8937 11.5019L21.9545 11.5019L21.9545 1.21808L-33.8937 1.21807L-33.8937 11.5019ZM-138.444 -11.7877L-138.444 -22.0704L-154.402 -22.0704L-154.402 -11.7877L-138.444 -11.7877ZM-12.3032 -45.3576L-139.085 -45.3576L-139.085 -35.0749L-12.3032 -35.0749L-12.3032 -45.3576Z" fill="#65D0E7" fillOpacity="0.5" />
                            </g>
...
const GitImportRepository: React.FunctionComponent<GitImportRepositoryProps> = ({ onImport, accessToken }) => {
    ...
    return (<>
        ...
        <p className="hw-text-sm">In order to make changes to the UI, we will need to access to your project on Github</p>
        <p className="hw-text-sm">Please select which project you would like to intergrate with Harmony</p>
        ...
        <>
            ...
            <div className="hw-grid hw-grid-cols-1 hw-gap-x-6 hw-gap-y-8 sm:hw-grid-cols-6">
                ...
                <Label className="sm:hw-col-span-full" label="Default Url">
                    <p className="hw-text-sm hw-text-gray-400">Enter the url of your staging app url.</p>
...
export const fonts: Font[] = [
    ...
    return (<>
        ...
        <p className="hw-text-sm">In the repository you selected, checkout a new branch to make these changes, eventually you will merge these changes back to master.</p>
        ...
        <p className="hw-text-sm">Noted that we marked NODE_ENV as the environment variable. You can change NODE_ENV to whatever make sense to your project.</p>

        <Header level={4}>Configure Data Tagging (NextJS Only)</Header>
        <p className="hw-text-sm">In order for the front-end to communicate with the code base, you need to use the Harmony SWC plugin. Create a next.config.js file in the root (if it doesn&#39;t exist) and insert the following code:</p>
        <CodeSnippet language="javascript" code={swcPluginCode} />

        <p className="hw-text-sm">Alternatively, if you are using .mjs for your Next.js config file. Insert the following code.</p>
