...
export const LoadingScreen: React.FunctionComponent<{ children: string }> = ({
  children,
}) => {
  return (
    <main className='hw-flex hw-min-h-screen hw-flex-col hw-items-center hw-justify-between hw-p-24'>
