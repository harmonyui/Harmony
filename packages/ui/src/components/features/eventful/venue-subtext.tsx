...
export const VenueSubText: React.FunctionComponent<VenueSubTextProps> = ({
  venue,
}) => {
  ...
  return (
    <div className="flex items-center justify-between font-semibold md:text-lg">
      <div className="hidden items-center space-x-3 md:flex hw-text-lg">
        <div className="flex">
          <p>{addressLine}</p>
          <p>, {city}</p>
          <p>, {state}</p>
      ...
      <div className="flex items-center space-x-2 text-center md:text-right hw-text-lg">
