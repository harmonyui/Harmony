...
export const BarsArrowDownIcon: IconComponent = (props) => {
  return (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="4 4 20 25" x="0px" y="0px">
      <g data-name="Layer 2">
...
export const PreviewIcon: IconComponent = (props) => {
  return (
    <FontAwesomeIcon icon={faArrowUpRightFromSquare} className={props.className} />
  )
}
...
export const UserGroupIcon: IconComponent = (props) => {
  return (
    <FontAwesomeIcon icon={faUserGroup} className={props.className} />
  )
}
...
export const LinkIcon: IconComponent = (props) => {
  return (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
      <path fillOpacity="1" fill-rule="nonzero" stroke="none" d="m5.525 13.657 2.652-2.652.707.707-2.652 2.652c-1.269 1.27-3.327 1.27-4.596 0-1.27-1.27-1.27-3.327 0-4.596l2.652-2.652.707.707-2.652 2.652c-.879.879-.879 2.303 0 3.182.879.879 2.303.879 3.182 0zm6.187-4.773-.707-.707 2.652-2.652c.879-.879.879-2.303 0-3.182-.879-.879-2.303-.879-3.182 0L7.823 4.995l-.707-.707 2.652-2.652c1.269-1.27 3.327-1.27 4.596 0 1.27 1.27 1.27 3.327 0 4.596l-2.652 2.652zm-5.45 1.62 4.242-4.242-.766-.766-4.242 4.242.766.766z"></path>
    </svg>
  )
}
...
export const RectangleListIcon: IconComponent = (props) => {
  return (
    <FontAwesomeIcon icon={faRectangleList} className={props.className} />
  )
}
...
export const GitBranchIcon: IconComponent = (props) => {
  return (
    <FontAwesomeIcon icon={faCodeBranch} className={props.className} />
...
export const PlayIcon: IconComponent = (props) => {
  return (
    <FontAwesomeIcon icon={faCirclePlay} className={props.className} />
  )
}
...
export const ToggleIcon: React.FunctionComponent<{ icon: IconComponent, selected: boolean, className: string }> = ({ icon: Icon, selected, className }) => {
  return (
    <Icon
      aria-hidden="true"
      className={getClass(
        (!className ? (selected ? 'hw-text-primary' : 'hw-text-gray-400 group-hover:hw-text-primary') : ''),
        'hw-h-6 hw-w-6 hw-shrink-0', className
      )}
    />
  )
}
...
export const SendIcon: IconComponent = (props) => {
  return (
    <svg {...props} viewBox="0 0 45 37" fill="none" xmlns="http://www.w3.org/2000/svg">
      <g clipPath="url(#clip0_673_28)">
        <path d="M6.56659 14.796C5.68643 14.5015 5.67771 14.026 6.58321 13.7232L38.7628 2.95697C39.6546 2.65915 40.1653 3.16011 39.916 4.03689L30.7209 36.3351C30.4678 37.2307 29.9538 37.2611 29.5761 36.4115L23.5168 22.7246L33.6323 9.18621L20.145 19.3397L6.56659 14.796Z" fill="white" />
      </g>
      <defs>
