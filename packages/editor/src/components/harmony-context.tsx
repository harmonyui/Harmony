...
export const HarmonyContext = createContext<HarmonyContextProps>({ isSaving: false, setIsSaving: noop, displayMode: 'designer', changeMode: noop, onFlexToggle: noop, scale: 1, onScaleChange: noop, onClose: noop, error: undefined, setError: noop, environment: 'production', showGiveFeedback: false, setShowGiveFeedback: noop, behaviors: [], setBehaviors: noop, isGlobal: false, setIsGlobal: noop, onComponentHover: noop, onComponentSelect: noop, selectedComponent: undefined, onAttributesChange: noop, });
