...
export interface DraggableContextProps {
	onDragEnd: (active: UniqueIdentifier, over: UniqueIdentifier | undefined) => void,
...
export const Droppable: React.FunctionComponent<DroppableProps> = ({id, children}) => {
...
export const Draggable: React.FunctionComponent<DraggableProps> = ({id, children}) => {
	...
	return (
		<div className={isDragging ? 'z-40' : ''} ref={setNodeRef} {...listeners} {...attributes} style={style}>
